...
if($totaldeleteid==""){
echo "<script>alert('Sorry No Record Found'); window.location.href = './index.php?page=Qthree_reportingd';</script>";exit;
}
...
echo "<script>alert('Update Successfull'); window.location.href = './index.php?page=Qthree_reportingd';</script>";exit;
...
<tr>
    <td>
<h3><?= __('TOTAL EDIT IDS')?> "<?php echo $totaledit_ids; if($totaledit_ids==""){echo "<script>alert('Sorry No Record Found');window.location.href = './index.php?page=Qthree_reporting';</script>";}?>"</h3>
...
<form action="./index.php?page=editquarter3d" method="post" autocomplete="off">
<?php
$j = 0;
