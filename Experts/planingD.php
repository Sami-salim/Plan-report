...
?>
           ...
           <a href="./index.php?page=Add_planD" class="btn btn-primary"><?= __('Add New')?></a>&nbsp&nbsp&nbsp&nbsp
		    <a href="./printpdf.php?page=home"class="btn btn-primary"><?= __('Data Export PDF')?></a>
		   <a href="./index.php?page=indexuplod" class="btn btn-primary"><?= __('UPlode')?></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
		    <a href="./index.php?page=home"class="btn btn-primary"><?= __('Home')?></a>
			<a href="codingstudio_data_downloadplan.php" class="float-right" download>Download excel File</a>
...
<form action="./index.php?page=editeD" method="post">
